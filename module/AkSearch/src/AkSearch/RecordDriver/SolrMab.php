...
class SolrMab extends SolrDefault  {
	...
	*/
	...
	public function getTitle() {
		$fullTitle = isset($this->fields['title']) ? str_replace(array('<', '>'), '', $this->fields['title']) : '';
		$fullTitle .= isset($this->fields['title_part_txt']) ? ', '.str_replace(array('<', '>'), '', $this->fields['title_part_txt']) : '';
		return $fullTitle;
	}
